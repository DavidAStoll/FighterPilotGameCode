/*
 ============================================================================
 Name		: Campaign3Map1.h
 Author	  : David Stoll
 Version	 : 1.0
 Copyright   : Copright � 2011 HQ Interactive Inc.
 Description : CCampaign3Map1 declaration
 ============================================================================
 */

#ifndef CAMPAIGN3MAP1_H
#define CAMPAIGN3MAP1_H
 ...
 * 
 */
class CCampaign3Map1 : public CMap
	{
public:
	// Constructors and destructor

	static CCampaign3Map1* New();

private:

	virtual ~CCampaign3Map1();
	CCampaign3Map1();
